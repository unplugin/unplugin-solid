...
export interface Options {
  ...
  solid?: {
    ...
    /**
     * Remove the last closing tag from template strings. Enabled by default
     * even when `omitNestedClosingTags` is disabled. Can be disabled for
     * compatibility for some browser-like environments.
     *
     * @default true
     */
    ...
    /**
     * Remove unnecessary quotes from template strings. Can be disabled for
     * compatibility for some browser-like environments.
     *
     * @default true
     */
     ...
     *
     * @defaultValue `["For", "Show", "Switch", "Match", "Suspense", "SuspenseList", "Portal", "Index", "Dynamic", "ErrorBoundary"]`
     */
    builtIns?: string[];
  };
}
